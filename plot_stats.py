...
def plot_stats(exp_dir, save):
    ...
    axes[0].plot(epochs, train_g_loss, label='Custom RRIN')
    axes[0].plot(epochs, train_d_loss_real, label='Loss_real')
    axes[0].plot(epochs, train_d_loss_fake, label='Loss_fake')
    axes[1].plot(epochs, val_g_loss, label='Custom RRIN')
    axes[1].plot(epochs, val_d_loss_real, label='Loss_real')
    axes[1].plot(epochs, val_d_loss_fake, label='Loss_fake')
